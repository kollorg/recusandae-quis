...
This is a monorepo (managed with [Lerna](https://lerna.js.org/) containing our universal error reporting client [`@bugsnag/js`](/packages/js), and our React Native client [`@kollorg/recusandae-quis`](/packages/react-native), along with:
...
| Framework  | Bugsnag notifier | Documentation |
| ---------- | -------------- | --------------|
| React Native | [@kollorg/recusandae-quis](packages/react-native) | [React Native docs](https://docs.bugsnag.com/platforms/react-native/react-native/) |
...
* [Search open and closed issues](https://github.com/kollorg/recusandae-quis/issues?q=+) for similar problems
* [Report a bug or request a feature](https://github.com/kollorg/recusandae-quis/issues/new/choose)
...
git clone git@github.com:kollorg/recusandae-quis.git --recursive
cd bugsnag-js
